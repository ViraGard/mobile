/**
 * Local fallback dataset — used only when Supabase env vars are missing
 * or the network fetch fails. Source of truth is supabase/setup.sql.
 */
import { Agency, Amusement, Category } from './types';

export { TAX_RATE } from './types';
export type { Agency, Amusement, AmusementOption, Category, TimeSlot } from './types';
